        ...
        tmpl: function() {
            ...
            return function(i, s) {
                ...
                if (!o) {
                    ...
                    i = i.replace(/##7b/g, "{").replace(/##7d/g, "}").replace(/##23/g, "#"),
                    i = "var " + t + "=[];" + n + i + '");return ' + t + '.join("");',
                    e[i] = o = new Function("opts", i)
                }
...
function() {
    ...
    t(Object, $.ObjectH),
    t(Array, $.ArrayH),
    t(Array.prototype, e($.ArrayH)),
    t(Function, $.FunctionH),
    t(Date, $.DateH),
    t(Date.prototype, e($.DateH)),
    t(String, $.StringH),
    t(String.prototype, e($.StringH))
} ();